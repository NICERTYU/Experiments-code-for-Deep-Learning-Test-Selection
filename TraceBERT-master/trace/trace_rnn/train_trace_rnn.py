...
def get_rnn_train_args():
    ...
    parser.add_argument("--rnn_arch", type=int, default=1, 
                        help="the test rnn_network architecture")
...
def main():
    ...
    model = RNNTracer1(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    if rnn_arch == 1:
       model = RNNTracer1(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 2:
        model = RNNTracer2(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 3:
        model = RNNTracer3(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 4:
        model = RNNTracer4(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 5:
        model = RNNTracer5(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 6:
        model = RNNTracer6(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)
    elif rnn_arch == 7:
        model = RNNTracer7(hidden_dim=args.hidden_dim, embd_info=embd_info, embd_trainable=args.is_embd_trainable,
                      max_seq_len=args.max_seq_len, is_no_padding=args.is_no_padding, rnn_type=args.rnn_type)

...
def get_train_args():
    ...
    parser.add_argument("--code_bert", default='./bert/codebert',
                        choices=['./bert/codebert', './bert/robert',
    ...
    parser.add_argument("--twin_type", type=int, default=1, help="For distributed training: twintype")
